...
public class ShakalarmSettingActivity extends Activity{
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// Get the AlarmManager Service
		super.onCreate(savedInstanceState);
		setContentView(R.layout.shakalarm_setting);
		...
		confirm_button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intentMain = new Intent(ShakalarmSettingActivity.this, MainActivity.class);
				ShakalarmSettingActivity.this.startActivity(intentMain);
