...
public class AccelerometerManager {
     ...
     */
    public static void startListening( AccelerometerListener accelerometerListener ) //will pass the accelerometerListener in Main (Wing)
    {
        ...
        if (sensors.size() > 0) {
            ...
            sensor = sensors.get(0); //get one of the sensor (Wing)
            
            // Register Accelerometer Listener
            running = sensorManager.registerListener( //set the listener listening to sensor selected above (Wing)
